...
export const custosProdutosProcessoConfig = mysqlTable("custos_produtos_processo_config", {
  ...
  logisticaPercentualPadrao: decimal("logisticaPercentualPadrao", { precision: 6, scale: 2 })
    .notNull()
    .default("10"),
...
export const custosProdutosFichas = mysqlTable("custos_produtos_fichas", {
  ...
  precoVendaReferenciaModo: mysqlEnum("precoVendaReferenciaModo", ["automatico", "manual"])
    .notNull()
    .default("automatico"),
