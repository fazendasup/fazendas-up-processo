...
export function Configuracoes() {
  ...
  const [perfil, setPerfil] = useState<"PROMOTER" | "LIDER_COLHEITA" | "GERENTE_COMERCIAL" | "COMERCIAL" | "OPERACOES" | "LOGISTICA" | "FINANCEIRO" | "ADMIN">("COMERCIAL");
                    ...
                    <div className="mt-4 grid gap-4 sm:grid-cols-2">
                      ...
                      <label className="block text-xs font-semibold uppercase text-[#6B7280]">
                        ...
                        >
                          ...
                          <option value="LIDER_COLHEITA">Líder de colheita</option>
